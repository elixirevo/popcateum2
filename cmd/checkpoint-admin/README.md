...
Currently, only the Popcateum mainnet and the default supported test networks (rinkeby, happycat) activate this feature. If you want to activate this feature in your private network, you can overwrite the relevant checkpoint oracle settings through the configuration file after deploying the oracle contract.
