...
var (
	...
	happycatFlag  = flag.Bool("happycat", false, "Initializes the faucet with Görli network config")
...
func main() {
	...
	genesis, err := getGenesis(*genesisFlag, *happycatFlag, *rinkebyFlag, *sepoliaFlag)
	if err != nil {
...
func getGenesis(genesisFlag string, happycatFlag bool, rinkebyFlag bool, sepoliaFlag bool) (*core.Genesis, error) {
	switch {
	case genesisFlag != "":
		...
		return &genesis, err
	case happycatFlag:
		return core.DefaultHappycatGenesisBlock(), nil
	case rinkebyFlag:
